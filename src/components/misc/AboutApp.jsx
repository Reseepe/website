...
const AboutApp = () => {
  return (
    <section className="flex flex-col items-center pt-7 gap-4" id="aboutApp" style={{ backgroundImage: `url(${Banner})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '820px' }}>
      ...
      <div className="max-w-[1440px] flex flex-col md:flex-row items-start gap-48">
        <div className="text-left flex-1 w-[740px]">
          ...
          <p className="text-xl mb-4 w-[740px] pb-4">
        ...
        <img src={phone} alt="App screenshot" className="w-full max-w-[400px]" />
      </div>
    </section>
  );
};
