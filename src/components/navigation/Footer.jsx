  ...
  return (
    <section className='bg-[#067D83] h-[240px] flex flex-col items-center justify-center gap-1'>
      <div class="flex space-x-7">
        <a href="" class="group">
          <div class="p-2 rounded-full transition-all duration-300 group-hover:bg-[black]">
            <img src={ig} alt="Instagram" class="transition-opacity duration-300 group-hover:opacity-100" />
          </div>
        </a>
        <a href="" class="group">
          <div class="p-2 rounded-full transition-all duration-300 group-hover:bg-[black]">
            <img src={fb} alt="Facebook" class="transition-opacity duration-300 group-hover:opacity-100" />
          </div>
        </a>
        <a href="" class="group">
          <div class="p-2 rounded-full transition-all duration-300 group-hover:bg-[black]">
            <img src={x} alt="X" class="transition-opacity duration-300 group-hover:opacity-100" />
          </div>
        </a>
        <a href="" class="group">
          <div class="p-2 rounded-full transition-all duration-300 group-hover:bg-[black]">
            <img src={gh} alt="GitHub" class="transition-opacity duration-300 group-hover:opacity-100" />
          </div>
        </a>
        <a href="" class="group">
          <div class="p-2 rounded-full transition-all duration-300 group-hover:bg-[black]">
            <img src={yt} alt="Youtube" class="transition-opacity duration-300 group-hover:opacity-100" />
          </div>
        </a>
      </div>
